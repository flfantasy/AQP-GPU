...
__global__ void queryKernel(int* lo_orderdate, int* lo_discount, int* lo_quantity, int* lo_extendedprice,
  ...
  BlockPredGTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(items1, 19940204, selection_flags, num_tile_items);
  BlockPredAndLTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(items1, 19940210, selection_flags, num_tile_items);
  ...
  BlockPredAndGTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(items1, 5, selection_flags, num_tile_items);
  BlockPredAndLTE<int, BLOCK_THREADS, ITEMS_PER_THREAD>(items1, 7, selection_flags, num_tile_items);
