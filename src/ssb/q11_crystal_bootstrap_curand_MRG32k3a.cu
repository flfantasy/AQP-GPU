...
__global__ void  curandGenKernel(curandStateMRG32k3a *curand_states,long clock_for_rand) {
...
void run(
  ...
  curandStateMRG32k3a *curand_state;
  CubDebugExit(g_allocator.DeviceAllocate((void**)&curand_state, MAX_CONCURRENT_THREADS * sizeof(curandStateMRG32k3a)));
